...
macro( words_afkortingen,
   ...
   beg,beh,'Bel',beleidsmedew,bep,ber,bet,betr,bew,bijg,bijv,bijw,bijz,
   ...
   'D.C',dbl,dd,decb,decemb,'Del','Den',dep,dept,'Deut',dgl,di,dir,diss,distr,div,dl,dld,dln,dmv,doct,
   ...
   'S.A',samenst,samenw,'Sanskr',sc,scen,schr,sp,spec,'Spr',st,'ST','Ste',str,subsp,symf,syn,
   ...
   'V.S',var,vb,vbb,'Ver',verd,verl,verm,vert,vervr,verz,vgl,'vice-vrz',vlp,
