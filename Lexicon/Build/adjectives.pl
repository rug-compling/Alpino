...
a([e(catastrofale),
   ...
   no_e(catastrofaal),
   st(catastrofaalst),
   ste(catastrofaalste)],adv,[],[]).

a([e(categoriale),
   no_e(categoriaal)],nonadv,[],[]).
...
a([e(complete),
   ...
   no_e(compleet),
   st(compleetst),
   ste(compleetste)],adv,[],[in]).

a([e(complementaire),
   no_e(complementair)],nonadv,[],[]).
...
a([ende(concurrerende),
   ...
   st(concurrerendst),
   ste(concurrerendste)],padv,[],[]).

a([e(conditionele),
   no_e(conditioneel)],padv,[],[]).

a([e(confessionele),
   no_e(confessioneel)],nonadv,[],[]).
...
a([e(constructieve),
   ...
   no_e(constructief),
   st(constructiefst),
   ste(constructiefste)],adv,[],[]).

a([e(consulaire),
   no_e(consulair)],adv,[],[]).

a([e(consumptieve),
   no_e(consumptief)],nonadv,[],[]).
...
a([e(continentale),
   no_e(continentaal)],nonadv,[],[]).

a([e(continue),
   no_e(continu)],adv,[],[]).

a([e(contractuele),
   no_e(contractueel)],adv,[],[]).
...
a([ge_e(gebruikte),
   ge_no_e(gebruikt)],adv,[],[h(veel),on]).
...
a([ge_e(gedifferentieerde),
   ...
   ste(gedifferentieerdste)],adv,[],[on]).
...
a([ge_e(gekristalliseerde),
   ge_no_e(gekristalliseerd)],adv,[],[]).

a([ge_e(gecritiseerde),
   ge_no_e(gecritiseerd)],adv,[],[]).
...
a([ge_e(genuanceerde),
   ...
   ge_no_e(genuanceerd),
   st(genuanceerdst),
   ste(genuanceerdste)],adv,[pp(in)],[on]).
...
a([ge_e(gerationaliseerde),
   ge_no_e(gerationaliseerd)],adv,[],[]).

a([ge_e(gerealiseerde),
   ge_no_e(gerealiseerd)],adv,[],[]).
...
a([ge_both(geschreven)],adv,[fixed([[op,het,lijf],dat])],[on]).
...
a([ge_e(gestroomlijnde),
   ge_no_e(gestroomlijnd),
   er(gestroomlijnder),
   ere(gestroomlijndere),
   st(gestroomlijndst),
   ste(gestroomlijndste)
  ],adv,[],[]).
...
a([ge_both(gewassen)],adv,[pp(tegen)],[on]). % er niet tegenop gewassen
				% cf opgewassen
...
a([ge_e(geïndividualiseerde),
   ge_no_e(geïndividualiseerd)],adv,[],[]).

a([ge_e(geïnduceerde),
   ge_no_e(geïnduceerd)],adv,[],[]).

a([ge_e(geïndustrialiseerde),
   ge_no_e(geïndustrialiseerd)],adv,[],[]).
...
a([ge_e(geïnstitutionaliseerde),
   ge_no_e(geïnstitutionaliseerd)],adv,[],[]).
...
a([e(kwalitatieve),
   ...
   no_e(kwalitatief),
   st(kwalitatiefst),
   ste(kwalitatiefste)],adv,[],[]).

a([e(kwantificeerbare),
   no_e(kwantificeerbaar)],nonadv,[],[]).
...
a([e(natuurlijke),
   ...
   no_e(natuurlijk),
   st(natuurlijkst),
   ste(natuurlijkste)],sentadv,[],[boven,on,tegen]).
...
a([e(trieste),
  ...
  [subject_sbar,
   subject_vp,
   object_sbar,  % ik ben triest dat het niet zo is VL
   object_vp
  ],[diep,in]).
...
a([pred([van,hetzelfde,laken,een,pak])],adv,[],[]).
...
a([ge_e(vermelde),
   ge_no_e(vermeld)],adv,[subject_sbar],[boven,on]).
...
%% het is niet voor iedereen weggelegd om...
a([ge_e(weggelegde),
