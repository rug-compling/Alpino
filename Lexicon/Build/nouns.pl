...
n([pl(archieven),sg(archief)],het,[],[sport]).
...
n([sg(bedevaartganger),pl(bedevaartgangers)],de,[]).
...
n([stem(beet_DIM),pl(beetjes),sg(beetje)],het,[mod,measure]).
...
n([pl(begrotingen),sg(begroting)],de,[],[ontwerp]).
...
n([pl(convenants),sg(convenant)],het,[app_measure]).
...
n([mass(gezondheidszorg)],de,[],[jeugd]).
...
n([sg(goedendag),sg(goeiendag)],de,[]).  % VL? "een simpele met ijzer beslagen stok"
...
n([pl(groepen),sg(groep)],de,[app_measure],
  [actie,aktie,
   ...
   s(leeftijd),
   lobby,
   mensenrechten, % en niet mens_recht_eng_roe_pen
   midden,
   nieuws,
   s(onderzoek),
   pop,
...
n([pl(knechten),pl(knechts),sg(knecht)],de,[],[dienst]).
...
%%n([sg(omwonende),pl(omwonenden)],de,[]).  %de direct omwonenden -> nominalized_adjective
...
n([pl(paddestoelen),sg(paddestoel)],de,[],[dim(paddestoeltje)]).
...
n([pl('president-curatoren'),pl('president-curators'),
   sg('president-curator')],de,[]).
...
n([sg(prijsafspraak),pl(prijsafspraken)],de,[]).

n([mass(prijscompensatie)],de,[]).

n([pl(prijskaartjes),sg(prijskaartje)],het,[]).

n([mass(prijskompensatie)],de,[]).

n([pl(prijsniveaus),sg(prijsniveau)],het,[pred_pp(beneden),pred_pp(boven)]).

n([sg(prijsstop),pl(prijsstops)],de,[]).

n([pl(prijsuitreikingen),sg(prijsuitreiking)],de,[]).

n([pl(prijsverschillen),sg(prijsverschil)],het,[]).

n([sg(prijsvraag),pl(prijsvragen)],de,[]).

n([pl(prijswinnaars),sg(prijswinnaar)],de,[]).
...
n([sg('prime-time'),sg([prime,time])],de,[temp_mod,sbar]).
...
n([pl('privé-levens'),sg('privé-leven'),
   pl(privélevens),sg(privéleven)],het,[]).
...
n([pl(projectors),sg(projector)],de,[]).
...
n([pl(publikaties),sg(publikatie)],de,[]).
...
n([pl(ramen),sg(raam)],both,[],[dim(raampje)]). % VL: de raam
...
n([pl(randgemeenten),pl(randgemeentes),sg(randgemeente)],de,[]).
...
n([pl(ratten),sg(rat)],de,[],[muskus]).  % geen mus_kus_rat
...
n([pl(rechthebbenden),sg(rechthebbende)],de,[]).
...
n([pl(rechtsstaten),sg(rechtsstaat),pl(rechtstaten),sg(rechtstaat)],de,[]).
...
n([pl(rechtszalen),sg(rechtszaal)],de,[]).
...
n([pl(reclameboodschappen),sg(reclameboodschap)],de,[]).
...
n([pl(recordaantallen),sg(recordaantal)],het,[measure]).
...
n([sg(recreatiemogelijkheid),pl(recreatiemogelijkheden)],de,[]).
...
n([mass('referentie-kader')],het,[]).

n([mass(referentiekader)],het,[]).
...
n([pl(regenjassen),sg(regenjas)],de,[]).
...
n([pl(regeringsstandpunten),sg(regeringsstandpunt)],het,[sbar,subject_sbar]).
...
n([pl('regio\'s'),pl(regionen),pl(regiones),sg(regio)],de,[],[micro]).
...
n([pl(reisdoelen),sg(reisdoel)],het,[]).

n([pl(reisgidsen),sg(reisgids)],de,[]).

n([pl(reistassen),sg(reistas)],de,[]).

n([pl(reisverhalen),sg(reisverhaal)],het,[]).
...
n([pl(reklames),sg(reklame)],de,[]).

n([pl(reklameboodschappen),sg(reklameboodschap)],de,[]).
...
n([pl(residenten),sg(resident)],de,[]).
...
n([pl(richtingen),sg(richting)],de,[app_measure],[kunst]).
...
n([pl(rijksarchieven),sg(rijksarchief)],het,[]).
...
n([sg(rijstrook),pl(rijstroken)],de,[]).
...
n([pl(ringen),sg(ring)],de,[measure],[dim(ringetje)]).  % de ringetjes ui
...
n([pl(rivierbeddingen),sg(rivierbedding)],de,[]).
...
n([pl(romanfiguren),sg(romanfiguur)],de,[]).

n([pl(romanschrijvers),sg(romanschrijver)],de,[]).
...
n([pl(rozen),sg(roos)],de,[measure],[dim(roosje)]).
...
n([pl(ruggen),sg(rug)],de,[],[dim(rugje),dim(ruggetje)]).

n([pl(ruggen),sg(rug)],de,[],[]).

n([pl(ruggegraten),sg(ruggegraat)],de,[vp]).
...
n([pl(ruggengraten),sg(ruggengraat)],de,[]).
...
n([pl(rundertjes),pl(rundjes),sg(rundje)],het,[]).
...
n([pl(schaatssters),sg(schaatsster)],de,[],
  [kunst,
   marathon,
   top]).
...
n([pl(schakelaars),sg(schakelaar)],de,[],[dim(schakelaartje)]).
...
n([pl(schoenendozen),sg(schoenendoos)],de,[]).

n([pl(schoenmakers),sg(schoenmaker)],de,[]).

n([pl(schoenzolen),sg(schoenzool)],de,[]).

n([sg(schoffel),pl(schoffels)],de,[]).

n([pl(schoften),sg(schoft)],de,[]).

n([pl(schokken),sg(schok)],de,[subject_vp,subject_sbar]).
...
n([pl(scholengemeenschappen),sg(scholengemeenschap)],de,[]).
...
n([pl(schroevedraaiers),sg(schroevedraaier)],de,[]).
...
n([pl(sculpturen),sg(sculptuur)],de,[]).
...
n([pl('secretarissen-generaal'),sg('secretaris-generaal'),
...
n([sg(smartphone),pl(smartphones),
   ...
   sg([smart,phone]),pl([smart,phone])],de,[]).

n([sg([smart,shop]),pl([smart,shops])],de,[]).
...
n([pl('sociaal-democraten'),sg('sociaal-democraat'),
   ...
   pl([sociaal,demokraten]),sg([sociaal,demokraat])],de,[]).

n([mass('sociaal-democratie'),
   mass([sociaal,democratie]),
   mass('sociaal-demokratie'),
   mass([sociaal,demokratie])],de,[]).
...
n([pl(stalen),sg(staal)],both,[measure],[dim(staaltje)]).
...
n([pl(staven),sg(staf)],de,[],[dim(stafje)]).
...
n([pl(standaarden),pl(standaards),sg(standaard)],de,[],[goud]).
...
n([pl(steigers),sg(steiger)],de,[],[dim(steigertje)]).
...
n([pl(stippen),sg(stip)],de,[],[midden]).
...
n([pl(stokken),sg(stok)],de,[measure],[dim(stokje),zuur]).
...
n([pl(strijden),sg(strijd)],de,[],[overname]).
...
n([pl(strottehoofden),sg(strottehoofd),
...
n([pl(takenpakketten),sg(takenpakket)],het,[]).
...
n([pl(tegengestelden),sg(tegengestelde)],het,[]).
...
n([pl(tehuizen),sg(tehuis)],het,[],[i(kind,kinder)]).
...
n([pl(theehuizen),sg(theehuis)],het,[]).

n([pl(theepotten),sg(theepot)],de,[]).
...
n([pl(tienduizenden)],de,[measure]).

n([pl(tieners),sg(tiener)],de,[]).

n([bare_meas(tienmaal),pl(tienmalen)],both,[temp_mod,measure,sbar]).

n([pl(tientjes),sg(tientje)],het,[measure]). % een tientje korting
...
n([pl(tikjes),sg(tikje),sg(tikkie)],het,
  [measure,
   mod]).
...
n([pl(tonen),sg(toon)],de,[vp],[dim(toontje)]).
...
n([pl(topsporters),sg(topsporter)],de,[]).
...
n([pl(transistors),sg(transistor)],de,[]).
...
n([mass(transport)],de,[]).  % "de transport sector"
...
n([pl(trouwringen),sg(trouwring)],de,[]).
...
n([pl('Tweede-Kamerleden'),sg('Tweede-Kamerlid')],het,[]).

n([pl(['2e','Kamerleden']),sg(['2e','Kamerlid'])],het,[]).
...
n([pl(uitersten),sg(uiterste)],het,[]).
...
n([pl(vacanties),sg(vacantie)],de,[]).

n([pl(vacantiegangers),sg(vacantieganger)],de,[]).
...
n([pl(vakantiegangers),sg(vakantieganger)],de,[]).
...
n([sg(veehouder),pl(veehouders)],de,[],[melk]).

n([mass(veehouderij)],de,[],[melk]).
...
n([pl(verbindingen),sg(verbinding)],de,[pred_pp(in)]).
...
n([sg(verkeersdode),pl(verkeersdoden)],de,[]).
...
n([mass(verraad)],het,[subject_vp,subject_sbar]).
...
n([pl(verzorgingshuizen),sg(verzorgingshuis)],het,[]).

n([pl(verzorgingstehuizen),sg(verzorgingstehuis)],het,[]).
...
n([pl(verzwaringen),sg(verzwaring)],de,[],[dijk]).

n([pl(vespers),sg(vesper)],de,[]).

n([pl(vesten),sg(vest)],het,[]).
...
n([pl(violen),sg(viool)],de,[],[dim(viooltje)]).
...
n([pl(vlekken),sg(vlek)],both,[measure],[dim(vlekje)]).
...
n([pl(volksliederen),sg(volkslied)],het,[]).
...
n([pl(volwassenen),sg(volwassene)],de,[]).
...
n([pl(voortuinen),sg(voortuin)],de,[]).
...
n([sg(werver),pl(wervers)],de,[],[l(fonds,fondsen)]).
...
n([pl(westkusten),sg(westkust)],de,[]).
...
n([pl(wijven),sg(wijf)],het,[],[dim(wijfje)]).
...
n([pl(zolen),sg(zool)],de,[],[dim(zooltje)]).
...
n([pl(zuidkusten),sg(zuidkust)],de,[]).
