...
%% één is a pronoun, therefore we treat 1 also as a pronoun
%% "slechts 1 op de 3 mensen ..."
%% n([sg('1')],de,[],[]).
...
n([pl(afmeldingen),sg(afmelding)],de,[],[]).
...
n([pl(afsluitingen),sg(afsluiting)],de,[],
  [weg,
   dim(afsluitinkje)]).
...
n([pl(agressies),sg(agressie)],de,[],[s(verkeer)]).
...
n([pl(algen),sg(alge),sg(alg)],de,[],[blauw]).
...
n([sg([avond,uit]),pl([avonden,uit])],de,[],[]).
...
n([pl(ballons),sg(ballon),pl(ballonnen)],de,[],
  [lucht,
   dim(ballonnetje)]).
...
n([sg(balsemien),pl(balsemienen)],de,[],[i(reus,reuzen),
					 spring
					]).
...
n([pl(banden),sg(band)],de,[],
  [s(aanvoerder),
   ...
   winter,
   zomer,
   j(['4', seizoen],['4',seizoens]),
   j([vier,seizoen],[vier,seizoens]),
   dim(bandje)]).
...
n([pl(bedieningen),sg(bediening)],de,[],[zelf]).
...
n([pl(bedreigingen),sg(bedreiging)],de,[],
  [s(dood)]).
...
n([pl(bergen),sg(berg)],de,[measure],
  [tafel,
   dim(bergje)]).
...
n([pl(bevelen),sg(bevel)],het,[sbar,vp,pred_pp(onder)],[nood]).
...
n([sg(bib),pl(bibs)],de,[],[]).  % VL voor bibliotheek
...
n([pl(bladen),sg(blad)],het,[],
  [bureau,
   ...
   hoef,
   kartel,
   i(heide_kartel,heidekartel),
   i(moeras_kartel,moeraskartel),
   tafel,
   vloei,
   werk]).  
...
n([sg(blauwtje),pl(blauwtjes)],het,[],
  [gentiaan,
   heide,
   pimpernel,
   staart
...
n([pl(bochten),sg(bocht)],de,[],
  [i(haar_speld,haarspeld),
   dim(bochtje)]).
...
n([pl(boswachterijen),sg(boswachterij)],de,[],[]).
...
n([pl(boterhammen),sg(boterham)],de,[],
  [middag,
   dim(boterhammetje)]).
...
n([pl(bronzen),sg(brons)],het,[],[h('EK')]).
...
n([pl(bunkers),sg(bunker)],de,[],[vogel]).

n([pl(burchten),sg(burcht)],de,[],[]).

n([pl(bureaus),pl('bureau\'s'),sg(bureau),
   sg(buro),pl('buro\'s')],both,
  [np_app_measure],
  [s(accountant),
   advies,
   s(arbeid),
...
n([sg(chatbot),pl(chatbots)],de,[],[h('AI')]).
...
n([sg(community),pl(communities)],de,[],[]).
...
n([sg(condoleance),pl(condoleances)],de,[],[]).
...
n([sg(conference),pl(conferences)],de,[],[s(oudejaar)]).
...
%% tijdstip
n([pl(data),pl(datums),sg(datum)],de,[temp_mod,sbar],[release]).
...
n([sg(digitalisering),pl(digitaliseringen)],de,[],[]).
...
n([pl(discriminaties),sg(discriminatie)],de,[],
  [s(leeftijd),
   moslim
  ]).
...
n([pl(doorrekeningen),sg(doorrekening)],de,[],[]).
...
n([pl(eenden),sg(eend)],de,[],
  [berg,
   i(buffel_kop,buffelkop),
   eider,
   ijs,
   kroon,
   kuif,
...
n([sg(ereprijs),pl(ereprijzen)],de,[],[]).
...
n([sg(escalatie),pl(escalaties)],de,[],[h(de)]).
...
n([pl(etappen),pl(etappes),sg(etappe)],de,
  [temp_mod],
  [berg,
   slot,
   'Tour'
...
n([sg(exclave),pl(exclaves)],de,[],[]).

n([sg(exclusiviteit),pl(exclusiviteiten)],de,[],[]).

n([pl(excursies),sg(excursie)],de,[sbar],[]).

n([pl(excursies),sg(excursie)],de,[],
  [i(zee_vogel,zeevogel)
  ]).
...
n([mass(fake),pl(fakes)],both,[],[deep]).
...
n([pl(files),sg(file)],de,[],[h('Epstein')]).
...
n([sg(flyer),pl(flyers)],de,[],[]).

n([pl(fobieën),sg(fobie)],de,[],[]).

n([pl(focussen),sg(focus)],de,
  [subject_sbar,
   subject_vp],[]).
...
n([pl(fotografen),sg(fotograaf)],de,[],['ANP',mode,pers,top]).
...
n([sg(fuut),pl(futen)],de,[],
  [i(rood_hals,roodhals)]).
...
n([pl(ganzen),sg(gans)],de,[],
  [brand,
   ...
   riet,
   rot,
   i(wit_buik_rot,witbuikrot),
   i(toendra_riet,toendrariet),
   i(rood_hals,roodhals),
   rot
  ]).
...
n([pl(gebieden),sg(gebied)],het,[np_app_measure,app_measure],
  [afzet,
   ...
   regen,
   risico,
   i(veiligheid_risico,veiligheidsrisico),
   i(rivier,rivieren),
   'Schengen',
   ski,
   s(station),
...
n([sg(geelster),pl(geelsterren)],de,[],
  [akker,
   bos,
   schede,weide
  ]).
...
n([sg(herneming),pl(hernemingen)],de,[],[]).
...
n([sg(hoogheemraadschap),pl(hoogheemraadschappen)],het,[],[]).
...
n([pl(hotels),sg(hotel)],het,[np_app_measure],
  [i(twee_ster,tweesterren),
   i(drie_ster,driesterren),
   i(vier_ster,viersterren),
   i(vijf_ster,vijfsterren),
   dim(hotelletje)]).

n([pl(hotels),sg(hotel)],het,[],
  [i(speler,spelers),
   dim(hotelletje)]).
...
n([pl('imago\'s'),sg(imago)],het,[sbar,vp],[]).
...
n([sg(influencer),pl(influencers)],de,[],[]).
...
n([pl(infrastructuren),sg(infrastructuur)],de,[],
  [h(energie),
   gas
  ]).
...
n([sg('jan-van-gent'),pl('jan-van-genten')],de,[],[]).
...
n([pl(juffers),sg(juffer)],de,[],
  [i(bos_beek,bosbeek),
   pantser,
   i(weide_beek,weidebeek),
   winter,
   dim(juffertje)]).
...
n([sg(karekiet),pl(karekieten)],de,[],[]).
...
%%% foto
%%% vogel (bruine, grauwe, blauwe, steppe-)
n([sg(kiek),pl(kieken)],de,[],
  [dim(kiekje),
   steppe]).

n([sg(kiekendief),pl(kiekendieven)],de,[],[steppe]).
...
n([pl(klauwen),sg(klauw)],de,[],
  [i(den_wolf,dennenwolfs),
   i(moeras_wolf,moeraswolfs),
   s(wolf),
   dim(klauwtje)]).

n([sg(klauwier),pl(klauwieren)],de,[],
  [i(rood_kop,roodkop)
  ]).
...
n([sg(kneu),pl(kneus)],de,[],[dim(kneutje)]).
...
n([pl(kragen),sg(kraag)],de,[],[riet]).

n([pl(kraaien),sg(kraai)],de,[],
  [i(alp,alpen),
   dim(kraaitje)]).
...
n([pl(kruiden),sg(kruid)],het,[],
  [barbara,
   i(duizend_gulden,duizendgulden),
   i(strand_duizend_gulden,strandduizendgulden),
   i(fluit,fluiten),
   i(fluit,fluite),
   fontein,
   glas,
...
n([pl(leveranciers),sg(leverancier)],de,[],
  [energie,
   hof]).
...
n([pl(libellen),sg(libel)],de,[],
  [heide,
   i(wit_snuit,witsnuit),
   dim(libelletje)]).
...
n([stem(locatie),
  ...
  [gas,
   i(nood_opvang,noodopvang),
   opvang]).

n([sg(lockdown),pl(lockdowns)],de,[],[]).
...
n([pl(lopers),sg(loper)],de,[],
  [i(drie_teen_strand,drieteenstrand),
   geld,
   i(krom_bek_strand,krombekstrand),
   marathon,
   oever,
   steen,
   stelt,
...
n([pl(malen),sg(maal)],het,[measure],
  [avond,
   middag,
   dim(maaltje)]).
...
n([sg(magnitude),pl(magnitudes)],de,[],[]).
...
n([pl(medailles),sg(medaille)],de,[],[h('EK')]).
...
n([pl(meeuwen),sg(meeuw)],de,[],
  [drieteen,
   dwerg,
   i(geel_poot,geelpoot),
   kok,
   mantel,
   storm,
   i(vork_staart,vorkstaart),
   zilver,
   i(zwart_kop,zwartkop),
   dim(meeuwtje)]).
...
n([pl(moerassen),sg(moeras)],het,[],[dim(moerasje)]).
...
n([pl(niveaus),sg(niveau),
   pl('nivo\'s'),sg(nivo)],het,[pred_pp(onder),pred_pp(onder,subject_vp),
				pred_pp(op),
				app_measure,
...
n([pl(omvolkingen),sg(omvolking)],de,[],[]).
...
n([pl(orchideeën),sg(orchidee)],de,[],[dim(orchideetje)]).

n([sg(orchis),pl(orchissen)],de,[],
  [i(bok,bokken),
   i(den,dennen),
   i(groen_knol,groenknol),
   kever,
   i(moeras_wesp,moeraswespen),
   i(mug,muggen),
   nacht,
   purper,
   riet,
...
n([pl(overtredingen),sg(overtreding)],de,[],[s(verkeer)]).
...
n([pl(papavers),sg(papaver)],de,[],[hoorn]).
...
n([pl(parkieten),sg(parkiet)],de,[],
  [i(hals_band,halsband),
   dim(parkietje)]).
...
n([sg(parnassia),pl('parnassia\'s')],de,[],[]).
...
n([pl(paviljoenen),pl(paviljoens),sg(paviljoen)],het,[],
  [dijk,
   strand,
   dim(paviljoentje)]).
...
n([sg(poleposition),pl(polepositions)],de,[],[]).
...
n([pl(ponten),sg(pont)],de,[],
  [fiets,
   i(zelf_bediening,zelfbedienings),
   dim(pontje)]).
...
n([sg(positiviteit),pl(positiviteiten)],de,[],[]).
...
n([sg(putter),pl(putters)],de,[],[dim(puttertje)]).
...
n([mass(quarantaine)],de,[pred_pp(in)],[thuis]).

n([sg(quark),pl(quarks)],both,[],[]).

n([sg(queer),pl(queers)],de,[],[]).
...
n([pl(ranglijsten),sg(ranglijst)],de,[app_measure],
  [wereld]).

n([pl(ranglijsten),sg(ranglijst)],de,[],
  [h('FIFA')]).
...
n([sg([real,life,soap]),sg(['real-life',soap]),sg('real-life-soap'),
   pl([real,life,soaps]),pl(['real-life',soaps]),pl('real-life-soaps')],de,[],[]).

n([sg([real,life,tv]),mass(['real-life',tv]),mass('real-life-tv')],de,[],[]).
...
n([sg(ref),pl(refs)],de,[],[]).  % VL voor scheidsrechter
...
n([pl(renners),sg(renner)],de,[],
  [s(beroep),
   s(klassement)]).

n([pl(rensters),sg(renster)],de,[],
  [s(beroep),
   s(klassement)]).
...
n([sg(rest),pl(resten)],de,
  [temp_mod,sbar,measure],
  [sneeuw,
   dim(restje)]).		% de rest van het jaar
...
n([pl(ritten),sg(rit)],de,[temp_mod],
  [auto,
   berg,
   i(koningin,koninginne),i(koningin,koninginnen),
   slot,
   test,
   veld,
   dim(ritje)]).
...
n([sg(roerdomp),pl(roerdompen)],de,[],[]).
...
n([pl(ruiters),sg(ruiter)],de,[],
  [bos,
   i(groen_poot,groenpoot),
   poel,
   dim(ruitertje)]).
...
n([pl(sancties),sg(sanctie)],de,[sbar,vp,subject_sbar,subject_vp],[h('EU')]).
...
n([sg('shoot-out'),pl('shout-outs')],de,[],[]).

n([sg(shortlist),pl(shortlists)],de,[],[]).
...
n([pl('Schriften'),sg('Schrift')],both,[],[]).
...
n([pl(scripts),sg(script)],both,[app_measure],[h('Videoland')]).
...
n([pl(sculpturen),sg(sculptuur)],both,[],[ijs]).
...
n([sg([short,list]),pl([short,lists]),
   sg(shortlist),pl(shortlists)
  ],de,[],[]).
...
n([sg(smelleken),pl(smellekens)],both,[],[]).
...
n([pl(soorten),sg(soort)],both,
  ...
  [dier,
   ...
   koraal,
   i(krab,krabben),
   libel, i(libel,libellen),  % en geen libelle
   i(meeuw,meeuwen),
   i(mier,mieren),
   i(mug,muggen),
   onder,
...
n([pl(soortementen),sg(soortement)],both,[measure],[]).
...
n([pl(struiken),sg(struik)],de,[measure],
  [meidoorn,
   dim(struikje)]).
...
n([sg(tapuit),pl(tapuiten)],de,[],
  [i(rood_borst,roodborst)]).
...
n([sg(tegenligger),pl(tegenliggers)],de,[],[]).
...
n([pl(teleurstellingen),sg(teleurstelling)],de,
  [subject_sbar,
   subject_vp,
   sbar
  ],[]).
...
n([sg(time)],de,[],[]).  % VL "eerste time" = eerste helft
...
n([pl(toepassingen),sg(toepassing)],de,
  [vp,
   pred_pp(van)],[]).
...
n([pl(toespraken),sg(toespraak)],de,[],[televisie]).
...
n([pl(tournees),sg(tournee)],de,[pred_pp(op)],
  [wereld,
   dim(tourneetje)]).
...
n([pl(transfers),sg(transfer)],both,[],[top]).
...
n([sg(transitie),pl(transities)],de,[],[energie]).

n([mass(transmissie)],de,[],[]).

n([mass(transparantie)],de,[],[]).

n([sg(transplantatie),pl(transplantaties)],de,[],
  [beenmerg,
   hart,
   long,
   xeno]).
...
n([pl('trauma\'s'),pl(traumata),sg(trauma)],both,[],[jeugd]).
...
n([pl(trips),sg(trip)],de,[temp_mod,sbar],
  [city,
   dim(tripje)]).
...
n([sg(vape),pl(vapes)],de,[],
  [i(smaak_DIM,smaakjes)]).

n([pl(varens),sg(varen)],de,[],
  [s(adelaar),
   beuk,
   maan,
   naald,
   i(steen_breek,steenbreek),
   stippel,
   tong,
   dim(varentje)]).
...
n([pl(varianten),sg(variant)],de,[],
  ['Andes',h('Andes'),
   bundibugyo,'Bundibugyo',h('Bundibugyo')
   ]).
...
n([pl(verdedigingen),sg(verdediging)],de,[],
  [lucht]).
...
n([pl(vleugelen),pl(vleugels),sg(vleugel)],de,[],
  [achter,
   voor,
   dim(vleugeltje)]).
...
n([pl(vliegvelden),sg(vliegveld)],het,[],[dim(vliegveldje)]).
...
n([pl(vlinders),sg(vlinder)],de,[],
  [aardbei,
   ...
   distel,
   dons,
   i(duin_parelmoer,duinparelmoer),
   hei,
   komma,
   s(koning),
   luzerne,
...
n([pl(voeten),sg(voet)],de,
  [pred_pp_pl(op),
   pred_pp(op)],[]).		% op vrije voeten/op goede voet

n([pl(voeten),sg(voet)],de,[],
  [i(gans,ganzen),
   linker,
   i(mel_gans,melganzen),
   opbrengst,
   rechter,
   rente,
   winst,
...
n([stem(volwassen),pl(volwassenen),sg(volwassene)],de,[],[jong]).
...
n([pl(voorzitters),sg(voorzitter)],de,[],
  [s(bestuur),bestuur,
   ...
   h('LPF'),
   h('IOC'),
   ['Europese','Commissie'],wh(['Europese','Commissie']),
   jury,
   i(jong,jongeren),
   'Kamer',
   ['Tweede','Kamer'],
...
n([pl(watervallen),sg(waterval)],de,[],[dim(watervalletje)]).
...
n([pl(weiden),pl(weides),
   sg(weide),sg(wei)],de,[],[dim(weitje)]).

n([pl(weigeringen),sg(weigering)],de,[vp],[]).

n([pl(weilanden),sg(weiland)],het,[],[dim(weilandje)]).
...
n([pl(wetten),sg(wet)],de,[],
  [amnestie,
   ...
   media,
   milieu,
   i(asiel_nood_maatregel,asielnoodmaatregelen),
   omroep,
   pers,
   reparatie,
   s(spreiding),
...
n([pl(winden),sg(wind)],de,[],
  [mee,
   i(noord,noorden),
   i(noord_west,noordwesten),
   i(noord_oost,noordoosten),
   i(oost,oosten),
   rij,
   rug,
   ruk,
   ...
   zee,
   i(zuid,zuiden),
   i(zuid_west,zuidwesten),
   i(zoud_oost,zuidoosten),
   dim(windje)
  ]).
...
n([pl(zangers),sg(zanger)],de,[],
  [gras,
   ...
   pop,
   riet,
   i(struik_riet,struikriet),
   sprinkhaan,
   s(volk),
   i(water_riet,waterriet)
  ]).
