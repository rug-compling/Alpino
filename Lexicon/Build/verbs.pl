...
m(v_root(heb,hebben),
  verb_heb(heb,hebt,heeft,hebben,gehad,had,hadden,hebben,
	...
	fixed([{[acc(aardigheid),er_pp(in,C)]},extra_sbar(C)],no_passive),
        fixed([{[acc(antwoord),pc(op)]}],no_passive),
...
v(breng,brengt,brengen,gebracht,bracht,brachten,
	...
	fixed([[in,mindering],acc],norm_passive),
	...
	fixed([pp_pred(in,beeld),sbar],imp_passive),  % in beeld brengen hoe ...
	...
	fixed([[in,kaart],sbar],imp_passive),  % in kaart brengen hoe ...
        ...
        fixed([[in,rekening],sbar],imp_passive),
	...
	fixed([svp_pp(in,praktijk),sbar],imp_passive),
	fixed([svp_pp(in,openbaarheid),acc],norm_passive),
	fixed([svp_pp(in,openbaarheid),sbar],imp_passive),
	...
	fixed([[te,binnen],refl],imp_passive),  % ouderwets
	fixed([[te,binnen],refl,sbar],imp_passive),  % ouderwets
	...
	fixed([[ter,sprake],sbar],imp_passive),
	fixed([[te,sprake],acc],norm_passive),
	fixed([[te,sprake],sbar],imp_passive),
	...
	fixed([[tot,uitdrukking],sbar],imp_passive),
	fixed([[tot,uiting],acc],norm_passive),
	fixed([[tot,uiting],sbar],imp_passive),
	fixed([svp_pp(in,herinnering),acc],norm_passive),
	fixed([svp_pp(in,herinnering),sbar],imp_passive),
	fixed([svp_pp(in,herinnering),{[acc,dat]}],norm_passive),
	fixed([svp_pp(in,herinnering),dat,sbar],imp_passive),
...
%%%  be used. "We hebben veel ervaring. Die hebben we opgedaan tijdens ..."
	...
	fixed([[de,ronde]],no_passive),
        fixed([[gestand],dat],imp_passive),
        fixed([[gestand],dat_pp(aan)],imp_passive),
...
v(druk,drukt,drukken,gedrukt,drukte,drukten,
	...
	np_ld_adv,
	np_np_ld_pp,
	fixed([er_pp(door,C),extra_sbar(C)],imp_passive),
	part_intransitive(af),
	part_intransitive(neer),
	part_sbar_subj_so_np(in),
...
%	fixed([{[[onderdoor],pc(aan)]}],no_passive),
	...
	fixed([[te,boven],dat],imp_passive),
...
%	pp_vp_obj(in),
	...
	fixed([[voor,de,geest],refl,sbar],imp_passive),
        fixed([[de,koekoek],[je]],no_passive),
...
v([houd,hou],houdt,houden,gehouden,hield,hielden,
	...
	fixed([[in,de,gaten],sbar],imp_passive),
	fixed([[in,de,smiezen],acc],no_passive),
	fixed([[in,de,smiezen],sbar],no_passive),
        fixed([ap_pred('in het oog'),acc],no_passive),
	fixed([svp_pp(in,achterhoofd),acc],norm_passive),
	fixed([svp_pp(in,achterhoofd),sbar],imp_passive),
	fixed([svp_pp(in,gedachte),acc],norm_passive),
	fixed([svp_pp(in,gedachte),sbar],imp_passive),
	fixed([[in,ogenschouw],acc],norm_passive),
	fixed([[in,ogenschouw],sbar],imp_passive),
	fixed([svp_pp(in,greep),acc],no_passive),
	...
	fixed([[overeind],sbar],imp_passive),
	fixed([[staande],acc],norm_passive),
	fixed([[staande],sbar],imp_passive),
...
v(knoop,knoopt,knopen,geknoopt,knoopte,knoopten,
	...
	fixed([svp_pp(in,oor),sbar],imp_passive),
	fixed([svp_pp(in,oor),refl,sbar],imp_passive),
  ...
  [z([part_so_np_pass(tegemoet),
   ...
   unacc([intransitive,			% ik kom!
	  ...
	  fixed([sbar_subj,ap_pred(ongelegen)],no_passive),
          ...
          fixed([[op,andere,gedachten]],no_passive),
	  ...
	  fixed([pc(aan),ap_pred(na)],no_passive), % hij was na aan de waarheid 
          ...
          fixed([[tot,leven]],no_passive),
          fixed([[tot,uiting]],no_passive),
          fixed([[tot,uiting],sbar_subj_no_het],no_passive),
...
v(laat,laat,laten,gelaten,liet,lieten,
	...
	fixed([vc(zie,inf,intransitive),sbar,sbar_subj],no_passive),   % dat hij komt laat zien dat hij ...
	...
	fixed([[achterwege],sbar],imp_passive),
 	fixed([[buiten,beschouwing],acc],norm_passive),
 	fixed([[buiten,beschouwing],sbar],imp_passive),
...
v(lap,lapt,lappen,gelapt,lapte,lapten,
	...
	fixed([svp_pp(aan,laars),sbar],imp_passive),
...
v(lever,levert,leveren,geleverd,leverde,leverden,
	...
	part_intransitive(in),
	part_sbar(op),
	part_fixed(op,[sbar_subj,acc],no_passive),
	part_fixed(op,[sbar_subj,{[acc,dat]}],no_passive),
	part_transitive(aan),
	part_transitive(af),
        part_transitive(door),
	part_transitive(in),
...
%	fixed([vp_subj_no_het,yt(svp_pp(voor,hand))],no_passive),
	...
	fixed([{[pc(op),subj(nadruk)]}],no_passive),
	fixed([{[er_pp(op,C),subj(nadruk)]},extra_sbar(C)],no_passive),
...
v(lijst,lijst,lijsten,gelijst,lijstte,lijstten,
	...
	part_intransitive(in),
	part_transitive(in),
	part_transitive(op)   % VL Deze zomermaanden lijst VRT NWS de tentoonstellingen van dit moment op .
       ])]).
...
v(loop,loopt,lopen,gelopen,liep,liepen,
	...
	fixed([[in,de,pas],pc(met)],no_passive),
...
%%	fixed([{[acc(gebruik),pc(van)]}],norm_passive), % geen gebruik werd ..
	...
	fixed([sbar_subj,acc(verschil)],no_passive),
...
v(neem,neemt,nemen,genomen,nam,namen,neme,
	...
	fixed([[in,acht],sbar],imp_passive),
	...
	fixed([ap_pred(kwalijk),dat],no_passive),  % neem me niet kwalijk
	...
	fixed([[voor,lief],sbar],imp_passive),
	fixed([[voor,lief],opt_het_pobj1(dat_sbar)],imp_passive),
...
v(noem,noemt,noemen,genoemd,noemde,noemden,
	...
	transitive,
        sbar,
	np_mod_pp(voor),   % zijn naam werd daar toen voor genoemd
	np_pc_pp(naar),
        fixed([{[acc(voorbeeld),pc(van)]}],no_passive),
        fixed([{[acc(voorbeeld),dat,pc(van)]}],no_passive),
	part_transitive(op),
...
v(peper,pepert,peperen,gepeperd,peperde,peperden,
	...
	part_fixed(in,[{[dat,het_pobj1]},nt(vp)],imp_passive),
	part_fixed(in,[dat,yt(vp)],imp_passive),
	part_fixed(in,[{[dat,het_pobj1]},nt(sbar)],imp_passive),
	part_fixed(in,[dat,yt(sbar)],imp_passive),
	pc_pp(in)])]).
...
v(sla,slaat,slaan,geslagen,sloeg,sloegen,
	...
	fixed([{[pc(op),acc(acht)]}],norm_passive),
        ...
        fixed([svp_acc(alarm),sbar],imp_passive),  % Artsen zonder Grenzen slaat alarm dat ebola ...
...
%	fixed([{[dat_pp(aan),acc(vraag)]}],norm_passive), subsumed by so_pp_np
	...
	fixed([{[[tewerk],acc]}],norm_passive),
        part_transitive(tewerk),
	fixed([[ten,dienste]],no_passive),
	fixed([{[pc(aan),[ten,dienste]]}],no_passive),
	fixed([{[pc(van),[ten,dienste]]}],no_passive),
	...
	fixed([pp_pred(aan,orde),sbar],imp_passive),  
	...
	fixed([svp_pp(op,prijs),het_pobj1(sbar)],imp_passive),
	fixed([svp_pp(op,prijs),het_pobj1(vp)],imp_passive),
	...
	fixed([[ter,discussie],sbar],imp_passive),
...
v(stoot,stoot,stoten,gestoten,[stootte,stiet],[stootten,stieten],
	...
	transitive,
	np_ld_pp,
	fixed([[uit,de,mond],[het,brood],dat],imp_passive),
	part_transitive(af),
	part_transitive(door),
...
v(val,valt,vallen,gevallen,viel,vielen,
	...
	fixed([[in,de,rede],dip_sbar],imp_passive),
...
v(wrijf,wrijft,wrijven,gewreven,wreef,wreven,
	...
	part_transitive(aan),
	part_transitive(in),
	part_transitive(op),   % het zilver op-wrijven
...
% 	fixed([[verplicht],refl,vp],no_passive),
	...
	fixed([[onder,ogen],sbar],imp_passive),
