...
m(v_root(heb,hebben),
  verb_heb(heb,hebt,heeft,hebben,gehad,had,hadden,hebben,
	...
	part_intransitive(plaats),     % de verkiezingen vonden toch plaats
	...
	fixed([{[[de,tijd],me,pc(voor)]}],imp_passive),
	fixed([{[[de,tijd],pc(voor)]}],imp_passive),
	...
	fixed([{[acc(weet),pc(van)]}],no_passive),
	fixed([{[acc(weet),er_pp(van,I)]},extra_sbar(I)],no_passive),
...
v(akteer,akteert,akteren,geakteerd,akteerde,akteerden,
    [h([intransitive])]).

v(aktiveer,aktiveert,aktiveren,geaktiveerd,aktiveerde,aktiveerden,
    [h([transitive,
	intransitive])]).
...
v(artikuleer,artikuleert,artikuleren,geartikuleerd,artikuleerde,artikuleerden,
    [h([intransitive,
	transitive])]).
...
v([barricadeer,barrikadeer],
  [barricadeert,barrikadeert],
  [barricaderen,barrikaderen],
  [gebarricadeerd,gebarrikadeerd],
  [barricadeerde,barrikadeerde],
  [barricadeerden,barrikadeerden],
  [h([% refl,
      transitive,
      np_mod_pp(met)])]).
...
v(breng,brengt,brengen,gebracht,bracht,brachten,
	...
	fixed([[op,de,been],acc],norm_passive),
...
v(deklameer,deklameert,deklameren,gedeklameerd,deklameerde,deklameerden,
    [h([intransitive,
	transitive])]).

v(dekreteer,dekreteert,dekreteren,gedekreteerd,dekreteerde,dekreteerden,
    [h([transitive])]).
...
v(desinfekteer,desinfekteert,desinfekteren,gedesinfekteerd,desinfekteerde,desinfekteerden,
    [h([transitive])]).
...
v(help,helpt,helpen,geholpen,hielp,hielpen,
	...
	fixed([[een,handje]],norm_passive),
	fixed([[een,handje],i(acc,A),obj_vp(A)],norm_passive),
	part_fixed(mee,[[een,handje],acc],norm_passive),
	part_fixed(mee,[[een,handje]],norm_passive),	
	fixed([[naar,de,klote],acc],norm_passive),
	fixed([[in,het,zadel],acc],norm_passive),
...
v(infekteer,infekteert,infekteren,geïnfekteerd,infekteerde,infekteerden,
    [h([transitive,
	np_pc_pp(met)])]).
...
v(inspekteer,inspekteert,inspekteren,geïnspekteerd,inspekteerde,inspekteerden,
    [h([intransitive,
	transitive])]).
...
v(kapituleer,kapituleert,kapituleren,gekapituleerd,kapituleerde,kapituleerden,
    [h([intransitive])]).
...
v(kastreer,kastreert,kastreren,gekastreerd,kastreerde,kastreerden,
    [h([transitive])]).
...
v(klassificeer,klassificeert,klassificeren,geklassificeerd,klassificeerde,klassificeerden,
    [h([als_pred_np,
	transitive])]).
...
v(knaag,knaagt,knagen,geknaagd,knaagde,knaagden,
	...
	fixed([dat_pp(aan),sbar_subj],no_passive),
...
v(kom,komt,komen,gekomen,kwam,kwamen,
  [z([part_so_np_pass(tegemoet),
   ...
   unacc([intransitive,			% ik kom!
	  ...
	  fixed([[gelegen]],no_passive),
	  fixed([[ongelegen]],no_passive),
	  fixed([[gelegen],dat],no_passive),
	  fixed([[ongelegen],dat],no_passive),
	  fixed([sbar_subj,[gelegen]],no_passive),
	  fixed([sbar_subj,[ongelegen]],no_passive),
          fixed([sbar_subj,[gelegen],dat],no_passive),
          fixed([sbar_subj,[ongelegen],dat],no_passive),
          ...
          fixed([[uit],[de,strot],dat],no_passive),	% dat komt me de strot uit
...
v(korrespondeer,korrespondeert,korresponderen,gekorrespondeerd,korrespondeerde,korrespondeerden,
    [h([intransitive,
	pc_pp(met)])]).

v(korrigeer,korrigeert,korrigeren,gekorrigeerd,korrigeerde,korrigeerden,
    [h([transitive])]).
...
v(koördineer,koördineert,koördineren,gekoördineerd,koördineerde,koördineerden,
    [h([transitive])]).
...
v(krijg,krijgt,krijgen,gekregen,kreeg,kregen,
	...
	fixed([{[er_pp(van,A),acc(weet)]},extra_sbar(A)],no_passive),
...
v(kulmineer,kulmineert,kulmineren,gekulmineerd,kulmineerde,kulmineerden,
    [h([intransitive])]).

v(kultiveer,kultiveert,kultiveren,gekultiveerd,kultiveerde,kultiveerden,
    [h([transitive])]).
...
v(lig,ligt,liggen,gelegen,lag,lagen,
	...
	fixed([[in,de,bedoeling]],no_passive),
	fixed([[in,de,bedoeling],sbar_subj],no_passive),
	fixed([[in,de,rede],sbar_subj],no_passive),
	fixed([[in,de,rede],vp_subj],no_passive),
	fixed([[in,de,bedoeling],vp_subj],no_passive),
...
v(like,liket,liken,geliked,likete,liketen,
    [h([transitive])]).
...
v(maak,maakt,maken,gemaakt,maakte,maakten,
	...
	mod_pp(bij),   % hij heeft er tekeningen/muziek/... bij gemaakt
	np_pc_pp(tot),
	np_pc_pp(uit),
	np_pc_pp(van),
...
%%	fixed([{[acc(gebruik),pc(van)]}],norm_passive), % geen gebruik werd ..
	...
	fixed([{[acc(indruk),pc(op)]}],no_passive),
        fixed([ap_pred('in orde'),acc],norm_passive),
	fixed([[kenbaar],acc],imp_passive),
	fixed([[kenbaar],{[acc,dat]}],imp_passive),
	...
	fixed([[kenbaar],{[acc,dat_pp(aan)]}],imp_passive),
...
v(nies,niest,niezen,geniesd,niesde,niesden,
    [h([intransitive])]).
...
v(oordeel,oordeelt,oordelen,geoordeeld,oordeelde,oordeelden,
    [h([intransitive,
	sbar,
	transitive,
	pc_pp(over)])]).
...
v(perfektioneer,perfektioneert,perfektioneren,geperfektioneerd,perfektioneerde,perfektioneerden,
    [h([transitive])]).
...
v(projekteer,projekteert,projekteren,geprojekteerd,projekteerde,projekteerden,
    [h([transitive])]).
...
v(rekonstrueer,rekonstrueert,rekonstrueren,gerekonstrueerd,rekonstrueerde,rekonstrueerden,
    [h([transitive])]).
...
v(scroll,scrollt,scrollen,gescrolld,scrollde,scrollden,
    [h([intransitive])]).
...
v(selekteer,selekteert,selekteren,geselekteerd,selekteerde,selekteerden,
    [h([transitive])]).
...
v(sympatiseer,sympatiseert,sympatiseren,gesympatiseerd,sympatiseerde,sympatizeerden,
    [h([pc_pp(met),
        intransitive])]).
...
v(versta,verstaat,inflected(verstaan,verstane),verstaan,verstond,verstonden,
    [h([refl,
	sbar,
        fixed_dep(intransitive),
...
v(vorm,vormt,vormen,gevormd,vormde,vormden,
	...
	fixed([{[acc(oordeel),pc(over)]}],no_passive),
...
v(zit,zit,zitten,gezeten,zat,zaten,
	...
	%so_np,
	ld_pp,
	nonp_copula,     % het zit goed; we zitten opgesloten
