...
lexicon_('Vrede',proper_name(X),Name,Ws1,Ws,slag(His),_LC) :-
    (  n_word(van,Ws1,[L|Ws2])
    ;  n_word('Van',Ws1,[L|Ws2])
    ),
    in_names_dictionary(proper_name(X,'LOC'),L,Stem,Ws2,Ws,His),
    hdrug_util:concat_all(['Vrede',van,Stem],Name,' ').

lexicon_('Akkoord',proper_name(X),Name,Ws1,Ws,slag(His),_LC) :-
    (  n_word(van,Ws1,[L|Ws2])
    ;  n_word('Van',Ws1,[L|Ws2])
    ),
    in_names_dictionary(proper_name(X,'LOC'),L,Stem,Ws2,Ws,His),
    hdrug_util:concat_all(['Akkoord',van,Stem],Name,' ').
...
optionally_drop_np_complement(np_pc_pp(Prep),pc_pp(Prep)).
...
spelling_variant31(een,en,twintigste,eenentwintigste).
spelling_variant31(twee,en,twintigste,tweeëntwintigste).
spelling_variant31(drie,en,twintigste,drieëntwintigste).
spelling_variant31(vier,en,twintigste,vierentwintigste).
spelling_variant31(vijf,en,twintigste,vijfentwintigste).
spelling_variant31(zes,en,twintigste,zesentwintigste).
spelling_variant31(zeven,en,twintigste,zevenentwintigste).
spelling_variant31(acht,en,twintigste,achtentwintigste).
spelling_variant31(negen,en,twintigste,negenentwintigste).

spelling_variant31(een,en,dertigste,eenendertigste).
spelling_variant31(twee,en,dertigste,tweeëndertigste).
spelling_variant31(drie,en,dertigste,drieëndertigste).
spelling_variant31(vier,en,dertigste,vierendertigste).
spelling_variant31(vijf,en,dertigste,vijfendertigste).
spelling_variant31(zes,en,dertigste,zesendertigste).
spelling_variant31(zeven,en,dertigste,zevenendertigste).
spelling_variant31(acht,en,dertigste,achtendertigste).
spelling_variant31(negen,en,dertigste,negenendertigste).

spelling_variant31(een,en,veertigste,eenenveertigste).
spelling_variant31(twee,en,veertigste,tweeënveertigste).
spelling_variant31(drie,en,veertigste,drieënveertigste).
spelling_variant31(vier,en,veertigste,vierenveertigste).
spelling_variant31(vijf,en,veertigste,vijfenveertigste).
spelling_variant31(zes,en,veertigste,zesenveertigste).
spelling_variant31(zeven,en,veertigste,zevenenveertigste).
spelling_variant31(acht,en,veertigste,achtenveertigste).
spelling_variant31(negen,en,veertigste,negenenveertigste).

spelling_variant31(een,en,vijftigste,eenenvijftigste).
spelling_variant31(twee,en,vijftigste,tweeënvijftigste).
spelling_variant31(drie,en,vijftigste,drieënvijftigste).
spelling_variant31(vier,en,vijftigste,vierenvijftigste).
spelling_variant31(vijf,en,vijftigste,vijfenvijftigste).
spelling_variant31(zes,en,vijftigste,zesenvijftigste).
spelling_variant31(zeven,en,vijftigste,zevenenvijftigste).
spelling_variant31(acht,en,vijftigste,achtenvijftigste).
spelling_variant31(negen,en,vijftigste,negenenvijftigste).

spelling_variant31(een,en,zestigste,eenenzestigste).
spelling_variant31(twee,en,zestigste,tweeënzestigste).
spelling_variant31(drie,en,zestigste,drieënzestigste).
spelling_variant31(vier,en,zestigste,vierenzestigste).
spelling_variant31(vijf,en,zestigste,vijfenzestigste).
spelling_variant31(zes,en,zestigste,zesenzestigste).
spelling_variant31(zeven,en,zestigste,zevenenzestigste).
spelling_variant31(acht,en,zestigste,achtenzestigste).
spelling_variant31(negen,en,zestigste,negenenzestigste).

spelling_variant31(een,en,zeventigste,eenenzeventigste).
spelling_variant31(twee,en,zeventigste,tweeënzeventigste).
spelling_variant31(drie,en,zeventigste,drieënzeventigste).
spelling_variant31(vier,en,zeventigste,vierenzeventigste).
spelling_variant31(vijf,en,zeventigste,vijfenzeventigste).
spelling_variant31(zes,en,zeventigste,zesenzeventigste).
spelling_variant31(zeven,en,zeventigste,zevenenzeventigste).
spelling_variant31(acht,en,zeventigste,achtenzeventigste).
spelling_variant31(negen,en,zeventigste,negenenzeventigste).

spelling_variant31(een,en,tachtigste,eenentachtigste).
spelling_variant31(twee,en,tachtigste,tweeëntachtigste).
spelling_variant31(drie,en,tachtigste,drieëntachtigste).
spelling_variant31(vier,en,tachtigste,vierentachtigste).
spelling_variant31(vijf,en,tachtigste,vijfentachtigste).
spelling_variant31(zes,en,tachtigste,zesentachtigste).
spelling_variant31(zeven,en,tachtigste,zevenentachtigste).
spelling_variant31(acht,en,tachtigste,achtentachtigste).
spelling_variant31(negen,en,tachtigste,negenentachtigste).

spelling_variant31(een,en,negentigste,eenennegentigste).
spelling_variant31(twee,en,negentigste,tweeënnegentigste).
spelling_variant31(drie,en,negentigste,drieënnegentigste).
spelling_variant31(vier,en,negentigste,vierennegentigste).
spelling_variant31(vijf,en,negentigste,vijfennegentigste).
spelling_variant31(zes,en,negentigste,zesennegentigste).
