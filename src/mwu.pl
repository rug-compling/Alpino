...
mwu_postag('hoog tijd',['ADJ(vrij,basis,zonder)','N(soort,ev,basis,zijd,stan)'],[hoog,tijd]).
...
mwu_postag('voor in de plaats',['VZ(fin)','VZ(init)','LID(bep,stan,rest)','N(soort,ev,basis,zijd)'],[voor,in,de,plaats]).
