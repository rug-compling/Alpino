...
mwu_postag('Binnenlandse zaken',['SPEC(deeleigen)','SPEC(deeleigen)'],['Binnenlandse','Zaken']).
mwu_postag('binnenlandse zaken',['SPEC(deeleigen)','SPEC(deeleigen)'],['Binnenlandse','Zaken']).
...
mwu_postag('buitenlandse zaken',['SPEC(deeleigen)','SPEC(deeleigen)'],['Buitenlandse','Zaken']).
mwu_postag('Buitenlandse zaken',['SPEC(deeleigen)','SPEC(deeleigen)'],['Buitenlandse','Zaken']).
