...
%% not used in any of the best parses of the training data for training
%% disambiguation models
unused_r1(a_a_sbar_hd_comp).
unused_r1(a_bracketed_int_adv_a).
unused_r1(abs_p_np_mod_dir).
unused_r1(abs_p_np_post_pp).
unused_r1(abs_p_predc_inv_dubb).
unused_r1(abs_p_predc_mod_sbar_inv).
unused_r1(abs_p_predc_mod_vp_inv).
unused_r1(adj_rel_vp_dp).
unused_r1(adv_ergens).
unused_r1(adv_mod_tag_sbar_dp).
unused_r1(adv_rel_vp_dp).
unused_r1(adv_tag_np_dp).
unused_r1(adv_tag_root_dp).
unused_r1(adv_vp_tag_dp).
unused_r1(adv_zo_van_sbar_dp).
unused_r1(a_num_na_a).
unused_r1(ap_quoted_dip).
unused_r1(a_vb_a).
unused_r1(bracketed_end_coord(adv,conj)).
unused_r1(bracketed_end_coord(det,conj)).
unused_r1(bracketed_end_coord(imp,conj)).
unused_r1(bracketed_end_coord(modifier,conj,c_mod)).
unused_r1(bracketed_end_coord(num,conj)).
unused_r1(bracketed_end_coord(num,conj,mod)).
unused_r1(bracketed_end_coord(pn,conj)).
unused_r1(bracketed_end_coord(pp,conj,c_mod)).
unused_r1(bracketed_end_coord(pp,conj,mod)).
unused_r1(bracketed_end_coord(pred,conj,mod)).
unused_r1(bracketed_end_coord(prep,conj,mod)).
unused_r1(bracketed_end_coord(rel,conj)).
unused_r1(bracketed_end_coord(root,conj,c_mod)).
unused_r1(bracketed_end_coord(root,conj,mod)).
unused_r1(bracketed_end_coord(sbar,conj)).
unused_r1(bracketed_end_coord(sv1,conj)).
unused_r1(bracketed_end_coord(vc,conj,mod)).
unused_r1(bracketed_end_coord(vc_noun,conj)).
unused_r1(bracketed_end_coord(vp,conj)).
unused_r1(bracketed_end_coord(vpx,conj)).
unused_r1(compar_adj_dan_obcomp).
unused_r1(compar_adv_dan_obcomp).
unused_r1(comparative(adv_np)).
unused_r1(comparative(empty_als)).
unused_r1(comparative(mod_np)).
unused_r1(compar_pp_dan_obcomp).
unused_r1(daarboven_ergens).
unused_r1(dash_ssub).
unused_r1(deverbal_vp_modpp_argpp).
unused_r1(deverbal_vp_v_arg(pred)).
unused_r1(dip_scope_sbar).
unused_r1(dit_allemaal_omdat).
unused_r1(dp_tag_dp_root).
unused_r1(end_coord(adv,conj,c_mod)).
unused_r1(end_coord(comp,conj)).
unused_r1(end_coord(finvp,conj,c_mod)).
unused_r1(end_coord(imp,conj,c_mod)).
unused_r1(end_coord(max,conj)).
unused_r1(end_coord(num,conj,c_mod)).
unused_r1(end_coord(part,conj,mod)).
unused_r1(end_coord(prep,conj,c_mod)).
unused_r1(end_coord(vc,conj,c_mod)).
unused_r1(end_coord(vp,conj,c_mod)).
unused_r1(hoe_np_short_hoe).
unused_r1(hoe_short_hoe).
unused_r1(max_np_wh_adv_mod_adv).
unused_r1(max_wh_adv_pp).
unused_r1(mid_coord(det)).
unused_r1(mid_coord(det,conj)).
unused_r1(mid_coord(enumeration)).
unused_r1(mid_coord(part)).
unused_r1(mid_coord(part,conj)).
unused_r1(mid_coord(rel,conj)).
unused_r1(mid_coord(vb)).
unused_r1(mid_coord(vb,conj)).
unused_r1(mid_coord(vc,conj)).
unused_r1(mid_coord(v,conj)).
unused_r1(mid_coord(within_word_conjunction(a),conj)).
unused_r1(mid_coord(within_word_conjunction(modifier))).
unused_r1(mid_coord(within_word_conjunction(n),conj)).
unused_r1(mid_coord(within_word_conjunction(num))).
unused_r1(mid_coord(within_word_conjunction(pp))).
unused_r1(mid_coord(within_word_conjunction(pred))).
unused_r1(mid_coord(within_word_conjunction(pred),conj)).
unused_r1(mid_coord(within_word_conjunction(vc_noun),conj)).
unused_r1(mod1b).
unused_r1(np_adv_tag_dp).
unused_r1(np_np_q_adv).
unused_r1(np_n_tmpnapp).
unused_r1(np_red_rel_edep_vp).
unused_r1(num_bracketed_adv_num).
unused_r1(op_v).
unused_r1(pn_pn_adv).
unused_r1(pp_p_arg(vp)).
unused_r1(pp_p_tag_arg(np)).
unused_r1(preda_adv_advp_dp).
unused_r1(predm_adv_sbar_dp).
unused_r1(predm_adv_vp_dp).
unused_r1(predm_ap_adv_dp).
unused_r1(predm_ap_wh_topicalization).
unused_r1(predm_pp_wh_topicalization).
unused_r1(pred_sbar_tag_dp).
unused_r1(pred_vp_tag_dp).
unused_r1(robust).
unused_r1(sat_nucl(oti)).
unused_r1(sat_nucl(sbar,whsub)).
unused_r1(sat_tag_nucl(pp)).
unused_r1(sat_tag_nucl(redrel)).
unused_r1(sat_tag_nucl(sbar)).
unused_r1(sat_tag_nucl(sbar_imp)).
unused_r1(sat_tag_nucl(sbar_ques)).
unused_r1(sat_tag_nucl(sbar,whsub)).
unused_r1(sbar(behalve_vp)).
unused_r1(sbar_want_dip_q).
unused_r1(sbar_want_dip_q2).
unused_r1(short_wh_sbar(advp_mod_mod)).
unused_r1(short_wh_sbar(np_mod_mod)).
unused_r1(short_wh_sbar(pp_mod_mod)).
unused_r1(start_comp_punct).
unused_r1(start_coord(comp,en)).
unused_r1(start_coord(max,en)).
unused_r1(start_coord(of(adv),en)).
unused_r1(start_coord(of(pp),en)).
unused_r1(start_coord(part,zowel_als)).
unused_r1(start_coord(root_niet,maar)).
unused_r1(start_coord(root_niet_pp,maar)).
unused_r1(start_coord(sbar,zowel_als)).
unused_r1(start_coord(within_word_conjunction(adv),zowel_als)).
unused_r1(start_coord(within_word_conjunction(a),zowel_als)).
unused_r1(start_max_dip_max).
unused_r1(start_tag_dip_max_q).
unused_r1(sv1_dip_sv1_haak).
unused_r1(tag_ssub).
unused_r1(top_bracketed_start).
unused_r1(top_start_anp).
unused_r1(top_start_np_tag_tag).
unused_r1(top_start_tag_np_tag).
unused_r1(top_start_tag_np_tag_pp).
unused_r1(top_start_tag_np_xp_tag).
unused_r1(top_tag_start_en).
unused_r1(uit_v).
unused_r1(vp_c_rootbar_c_v).
unused_r1(vp_dip_vp_ligg).
unused_r1(vp_hellip_arg_v(adv)).
unused_r1(vp_hellip_arg_v(pp)).
unused_r1(vp_imp).
unused_r1(vpnoun_v_extra).
unused_r1(vpnoun_v_inf).
unused_r1(vpnoun_v_pp).
unused_r1(vp_tag_vp1).
unused_r1(vp_v_bracketed_extra_rel).
unused_r1(vp_v_bracketed_m_extra_vp).
unused_r1(vp_v_komma_arg(adv)).
unused_r1(wh_sbar_arg_m(adv)).
unused_r1(wh_sbar_arg_m(modifier_pp)).
unused_r1(wh_sbar_arg_m(pp)).
unused_r1(wh_sbar_arg_m(pred)).
unused_r1(zowel_swap(within_word_conjunction,np_det_n)).

less_used_r1(Id):-
    unused_r1(Id).

%% frequency between 1 and 10:
less_used_r1(vp_vp_dip_q_nocolon).
less_used_r1(vp_dip_vp).
less_used_r1(pron_pron_loc_adv).
less_used_r1(pp_p_part).
less_used_r1(pp_np_p).
less_used_r1(n_year_n).
less_used_r1(np_np_comma_adv).
less_used_r1(non_wh_topicalization_dip_pred).
less_used_r1(n_n_napp_app_start_colon).
less_used_r1(mid_coord(pred,conj)).
less_used_r1(vc_mod_vb).
less_used_r1(short_wh_sbar(np_mod)).
less_used_r1(pred_inf_rel).
less_used_r1(np_quoted_dip).
less_used_r1(mid_coord(within_word_conjunction(n))).
less_used_r1(mid_coord(vc)).
less_used_r1(max_xp(vpx)).
less_used_r1(max_xp(post_pp)).
less_used_r1(ecomp).
less_used_r1(a_ligg_mod_a).
less_used_r1(adv_adv_modroot(min)).
less_used_r1(start_coord(root_imparative,en)).
less_used_r1(sbar_npmod_sbar).
less_used_r1(ques_ques).
less_used_r1(ques_np).
less_used_r1(pron_pron_napp).
less_used_r1(pp_p_mod_arg(np)).
less_used_r1(n_bracketed_num_n).
less_used_r1(max_wh_adv_ap).
less_used_r1(dit_om).
less_used_r1(deverbal_vp_predm_adj_v).
less_used_r1(bracketed_mod_start).
less_used_r1(bracketed_end_coord(n,conj)).
less_used_r1(bracketed_end_coord(a,conj)).
less_used_r1(adv_np_dp).
less_used_r1(top_start_etc).
less_used_r1(start_coord(num,zowel_als)).
less_used_r1(sat_tag_nucl(np)).
less_used_r1(q_sbar_punct).
less_used_r1(pred_vp_dp).
less_used_r1(predm_adv_pp_dp).
less_used_r1(pp_part_pp_dp).
less_used_r1(num_pp_dp).
less_used_r1(n_adv_n).
less_used_r1(mid_coord(adv)).
less_used_r1(end_coord(vp,conj,mod)).
less_used_r1(end_coord(root,conj,c_mod)).
less_used_r1(eenmaal_absolute).
less_used_r1(deverbal_vp_v_arg(sbar)).
less_used_r1(comparative(a)).
less_used_r1(ap_wh_ap_adv).
less_used_r1(adj_mod_sbar_dp).
less_used_r1(wh_sbar_arg_inf(np)).
less_used_r1(vp_v_bracketed_m_extra).
less_used_r1(vp_hellip_arg_v(np)).
less_used_r1(vandaag_woensdag).
less_used_r1(start_coord(part,en)).
less_used_r1(sbar(dubb)).
less_used_r1(pred_zoals_cp).
less_used_r1(np_zoon_n).
less_used_r1(non_wh_topicalization(vp)).
less_used_r1(niet_np).
less_used_r1(mid_coord(num)).
less_used_r1(max_wh_adv_adv).
less_used_r1(end_coord(sbar,conj,mod)).
less_used_r1(end_coord(pred,conj,c_mod)).
less_used_r1(end_coord(part,conj)).
less_used_r1(end_coord(modifier,conj,c_mod)).
less_used_r1(a_pp_dp).
less_used_r1(ap_dip).
less_used_r1(a_part_a).
less_used_r1(alle_zes_pre_det_quant).
less_used_r1(abs_p_predc_sbar_inv).
less_used_r1(vp_predm_v_comma).
less_used_r1(vp_dip_vp_no_comma).
less_used_r1(vp_dip_vp2).
less_used_r1(top_start_tag_root_imp).
less_used_r1(start_max_tag_max).
less_used_r1(start_coord(within_word_conjunction(np),zowel_als)).
less_used_r1(start_coord(quest_short,en)).
less_used_r1(sbar(dubb_sbar)).
less_used_r1(rel_arg(meas_mod_np)).
less_used_r1(q_vb).
less_used_r1(pron_pron_modroot(min)).
less_used_r1(pp_p_arg(start1)).
less_used_r1(np_imp).
less_used_r1(mid_coord(within_word_conjunction(np),conj)).
less_used_r1(mid_coord(n,conj)).
less_used_r1(hoe_np_hoe_np).
less_used_r1(hoe_hoe).
less_used_r1(end_coord(en_hellip)).
less_used_r1(bracketed_end_coord(modifier,conj)).
less_used_r1(wh_sbar_mod_inf(pp)).
less_used_r1(vp_v_komma_arg(rel)).
less_used_r1(vp_v_komma_arg(pred_heavy)).
less_used_r1(vp_dashed_predm_v_adj).
less_used_r1(vp_bracketed_predm_v_adj).
less_used_r1(vp_arg_comma_v(np)).
less_used_r1(top_adv_tag_start_sv1).
less_used_r1(start_tag_dip_max).
less_used_r1(start_coord(within_word_conjunction(modifier),en)).
less_used_r1(start_coord(of(modifier),en)).
less_used_r1(start_coord(dip,np,en)).
less_used_r1(start_comp).
less_used_r1(short_wh_sbar(advp_mod)).
less_used_r1(sbar(behalve_np)).
less_used_r1(sat_nucl(sbar_ques)).
less_used_r1(q_pp).
less_used_r1(preda_adv_np_dp).
less_used_r1(pp_npmod_pp).
less_used_r1(num_adv_dp).
less_used_r1(np_tmp_det_num_n).
less_used_r1(mid_coord(sbar)).
less_used_r1(mid_coord(a,conj)).
less_used_r1(hoe_np_hoe).
less_used_r1(end_coord(pp,conj,c_mod)).
less_used_r1(deverbal_vp_part_v).
less_used_r1(deverbal_v_inv_v_v).
less_used_r1(alle_zes).
less_used_r1(abs_p_mod_predc).
less_used_r1(a_a_sinf_tough).
less_used_r1(waar_nodig).
less_used_r1(vp_v_predm).
less_used_r1(vp_vp1_tag).
less_used_r1(vp_dip_vp_ligg2).
less_used_r1(sv1_dip_sv1_ligg).
less_used_r1(start_coord(within_word_conjunction(num),en)).
less_used_r1(start_coord(root_niet_root,maar)).
less_used_r1(start_coord(prep,zowel_als)).
less_used_r1(start_coord(dip,root,en)).
less_used_r1(predm_adv_ap_dp).
less_used_r1(pp_p_arg_part(pp)).
less_used_r1(num_cp_num).
less_used_r1(nucl_tag_sat(sbar)).
less_used_r1(np_np_ap).
less_used_r1(n_n_pnappgen).
less_used_r1(mid_coord(vpx,conj)).
less_used_r1(mid_coord(vproj,conj)).
less_used_r1(mid_coord(vp,conj)).
less_used_r1(mid_coord(v)).
less_used_r1(mid_coord(pn,conj)).
less_used_r1(mid_coord(imp)).
less_used_r1(max_np_wh_adv_adv).
less_used_r1(imp_np).
less_used_r1(end_coord(vb,conj,mod)).
less_used_r1(end_coord(prep,conj,mod)).
less_used_r1(eenmaal_absolute_pp).
less_used_r1(dp_dp_oti).
less_used_r1(deverbal_vp_arg_v(adv)).
less_used_r1(bracketed_end_coord(vproj,conj)).
less_used_r1(app_n_pn_app_n).
less_used_r1(adv_dip_root_dp).
less_used_r1(adv_adv_adj).
less_used_r1(a_a_lig_mod).
less_used_r1(within_word_conjunction(zowel_als_np)).
less_used_r1(wh_topicalization(np,vp)).
less_used_r1(wat_als).
less_used_r1(vp_v_extra_pred).
less_used_r1(vp_pred_v_sbar).
less_used_r1(vp_hellip_arg_v(pred)).
less_used_r1(v_bracketed_v_v).
less_used_r1(top_tag_np_tag_start_xp(root)).
less_used_r1(start_max_dip_max_q2).
less_used_r1(start_coord(within_word_conjunction(pred),zowel_als)).
less_used_r1(start_coord(within_word_conjunction(pred),en)).
less_used_r1(start_coord(of(np),en)).
less_used_r1(start_coord(enumeration,en)).
less_used_r1(start_coord(dipq,root,en)).
less_used_r1(start_coord(dipq2,root,en)).
less_used_r1(start_coord(dipq1,root,en)).
less_used_r1(short_hoe_short_hoe).
less_used_r1(sbar_want_dip).
less_used_r1(sbar_punct).
less_used_r1(sbar(behalve_sbar)).
less_used_r1(sat_dip_nucl(sbar)).
less_used_r1(pron_pron_modroot(haak)).
less_used_r1(predm_advp_adv_dp).
less_used_r1(pp_p_br_mod_arg(np)).
less_used_r1(pp_p_arg(start2)).
less_used_r1(pp_imp).
less_used_r1(pp_aldus_mod_arg(np)).
less_used_r1(pp_aldus_arg_mod(np)).
less_used_r1(nucl_tag_sat(redrel)).
less_used_r1(mid_coord(within_word_conjunction(a))).
less_used_r1(mid_coord(sbar,conj)).
less_used_r1(mid_coord(rel)).
less_used_r1(mid_coord(prep)).
less_used_r1(mid_coord(pp,conj)).
less_used_r1(mid_coord(num,conj)).
less_used_r1(mid_coord(adv,conj)).
less_used_r1(imp_part_imp).
less_used_r1(end_coord(sbar,conj,c_mod)).
less_used_r1(end_coord(num,conj,mod)).
less_used_r1(end_coord(enumeration,conj)).
less_used_r1(deverbal_vp_predm_v).
less_used_r1(daarom_immers).
less_used_r1(compar_np_dan_obcomp).
less_used_r1(bracketed_end_coord(vc,conj)).
less_used_r1(bracketed_end_coord(root,conj)).
less_used_r1(bracketed_end_coord(modifier,conj,mod)).
less_used_r1(aan_het_n_v).
less_used_r1(zowel_swap(within_word_conjunction(np))).
less_used_r1(within_word_conjunction(zowel_als_pp)).
less_used_r1(wh_sbar_arg_m(np)).
less_used_r1(v_v_bracketed_v).
less_used_r1(vpnoun_v_sbar).
less_used_r1(vpnoun_v_m_extra).
less_used_r1(vp_dip_vp_haak2).
less_used_r1(vp_dashed_predm_v).
less_used_r1(vp_bracketed_predm_v).
less_used_r1(top_start_tag_np_imp).
less_used_r1(start_tag_dip_max_q2).
less_used_r1(start_max_dip_max_q).
less_used_r1(start_coord(within_word_conjunction(vc_noun),en)).
less_used_r1(start_coord(within_word_conjunction(pp),en)).
less_used_r1(start_coord(within_word_conjunction(modifier),zowel_als)).
less_used_r1(start_coord(within_word_conjunction(adv),en)).
less_used_r1(start_coord(vp,zowel_als)).
less_used_r1(start_coord(vc,zowel_als)).
less_used_r1(start_coord(det,zowel_als)).
less_used_r1(start_coord(adv,zowel_als)).
less_used_r1(short_wh_sbar(pp_mod)).
less_used_r1(sbar_want_tag).
less_used_r1(sbar(quoted_a)).
less_used_r1(sbar(mod_pp)).
less_used_r1(sbar(mod_np)).
less_used_r1(sbar(behalve_pp)).
less_used_r1(predm_adv_advp_dp).
less_used_r1(pred_adv_sbar_dp).
less_used_r1(pp_p_d_mod_arg(np)).
less_used_r1(nucl_sat(post_pp)).
less_used_r1(mid_coord(vc_noun)).
less_used_r1(mid_coord(prep,conj)).
less_used_r1(mid_coord(imp,conj)).
less_used_r1(mid_coord(finvp,conj)).
less_used_r1(max_wh_adv_mod_np).
less_used_r1(max_wh_adv_mod_adv).
less_used_r1(hoe_hoe_np).
less_used_r1(end_coord(imp,conj,mod)).
less_used_r1(end_coord(adv,conj,mod)).
less_used_r1(eenmaal_absolute_loc).
less_used_r1(dit_allemaal_vanwege).
less_used_r1(dit_allemaal_om).
less_used_r1(deverbal_vp_v_arg(vp)).
less_used_r1(det_bracketed_adv_det).
less_used_r1(comparative(adv_pp)).
less_used_r1(bracketed_te).
less_used_r1(bracketed_end_coord(v,conj)).
less_used_r1(bracketed_end_coord(prep,conj)).
less_used_r1(bracketed_end_coord(pred,conj)).
less_used_r1(bracketed_end_coord(pp,conj)).
less_used_r1(bracketed_end_coord(np,conj,c_mod)).
less_used_r1(bracketed_end_coord(finvp,conj)).
less_used_r1(a_tot_me_comp_a).
less_used_r1(a_tag_pp_dp).
less_used_r1(a_er_a).
less_used_r1(advp_imp).
less_used_r1(adj_vp_dp).
less_used_r1(abs_p_np_dir).

%% frequency between 10 and 50:
less_used_r1(vp_np_v_sbar).
less_used_r1(start_dq2_max_dip).
less_used_r1(end_coord(finvp,conj,mod)).
less_used_r1(vp_v_komma_arg(np_heavy)).
less_used_r1(deverbal_vp_arg_v(pred)).
less_used_r1(adv_mod_sbar_dp).
less_used_r1(np_ap).
less_used_r1(a_a_modcp).
less_used_r1(v2_vp_dubb_vproj).
less_used_r1(rel_arg(pred)).
less_used_r1(rel_arg(adv)).
less_used_r1(max_wh_adv_np).
less_used_r1(end_coord(vc,conj,mod)).
less_used_r1(adv_adv_dp).
less_used_r1(xp_en_ques).
less_used_r1(wh_sbar_arg(adv)).
less_used_r1(q_v).
less_used_r1(vp_pred_v_en_pred).
less_used_r1(n_n_napp_app_start1).
less_used_r1(n_n_modroot(comma)).
less_used_r1(end_coord(imp,conj)).
less_used_r1(within_word_conjunction(en_np)).
less_used_r1(vp_vp_dip_q).
less_used_r1(start_dq1_max_dip_no_comma).
less_used_r1(start_coord(within_word_conjunction(a),en)).
less_used_r1(mid_coord(root,conj)).
less_used_r1(a_a_bracketed_mod).
less_used_r1(short_wh_sbar(pp)).
less_used_r1(sat_nucl(pp)).
less_used_r1(pron_pron_mod_a).
less_used_r1(non_wh_topicalization(adv)).
less_used_r1(adv_root_dp).
less_used_r1(short_wh_sbar(np)).
less_used_r1(n_n_pntag).
less_used_r1(a_fixed_a).
less_used_r1(predm_topicalization).
less_used_r1(non_wh_topicalization(pp_pp)).
less_used_r1(n_n_n_pnapp).
less_used_r1(deverbal_vp_arg_v(pp)).
less_used_r1(abs_p_np_mod).
less_used_r1(pp_adv_dp).
less_used_r1(q_imp).
less_used_r1(predm_adv_np_dp).
less_used_r1(mid_coord(sv1,conj)).
less_used_r1(comparative(vpx)).
less_used_r1(adj_te_zien).
less_used_r1(a_a_modcp_pred).
less_used_r1(n_dashed_mod_n).
less_used_r1(vp_dip_vp1).
less_used_r1(wh_topicalization(modifier,vp)).
less_used_r1(vp_np_v_ap).
less_used_r1(niet_pp).
less_used_r1(imp_mod_imp).
less_used_r1(dit_vanwege).
less_used_r1(a_hoe_a).
less_used_r1(xp_modal_xp(vp_modifier)).
less_used_r1(sbar(van)).
less_used_r1(pron_pron_gennp).
less_used_r1(pp_p_arg(a)).
less_used_r1(end_coord(en_tag)).
less_used_r1(end_coord(det,conj)).
less_used_r1(adv_adv_sbar).
less_used_r1(start_coord(det,en)).
less_used_r1(short_wh_sbar(advp)).
less_used_r1(sbar(adv)).
less_used_r1(q_vp).
less_used_r1(pp_sbar_dp).
less_used_r1(mid_coord(vpx)).
less_used_r1(mid_coord(vproj)).
less_used_r1(adv_dat_sbar_dp).
less_used_r1(start_coord(vb,en)).
less_used_r1(ques_dan).
less_used_r1(pp_pp_adv).
less_used_r1(van_en).
less_used_r1(sat_nucl(sbar_imp)).
less_used_r1(sat_nucl(redrel)).
less_used_r1(padv_root_dp).
less_used_r1(np_np_year).
less_used_r1(mid_coord(within_word_conjunction(np))).
less_used_r1(loc_pp_dp).
less_used_r1(a_predm_a).
less_used_r1(adv_vp_dp).
less_used_r1(sv1_dip_sv1).
less_used_r1(start_dq2_max_dip_no_comma).
less_used_r1(pred_pp_vol).
less_used_r1(comparative(sbar)).
less_used_r1(zowel_swap(np)).
less_used_r1(start_coord(sv1_imparative,en)).
less_used_r1(sat_nucl_nocomma(sbar)).
less_used_r1(max_xp(adj)).
less_used_r1(end_coord(vb,conj)).
less_used_r1(end_coord(np,conj,c_mod)).
less_used_r1(sbar(vpx)).
less_used_r1(np_wh_np_adv).
less_used_r1(n_dashed_adj_n).
less_used_r1(n_comma_adj_comma_n).
less_used_r1(mid_coord(modifier,conj)).
less_used_r1(start_dq3_max_dip).
less_used_r1(pron_pron_dus).
less_used_r1(pron_pron_cp).
less_used_r1(bracketed_end_coord(np,conj)).
less_used_r1(a_predm_a_adj).
less_used_r1(adv_wh_adv_adv).
less_used_r1(wat_te_eten).
less_used_r1(start_coord(a,zowel_als)).
less_used_r1(sbar(sbar)).
less_used_r1(adv_adv_rel).
less_used_r1(adv_adv_modroot(haak)).
less_used_r1(sv1_smain_sv1).
less_used_r1(start_coord(pred,zowel_als)).
less_used_r1(vp_c_whq_c_v).
less_used_r1(start_coord(pp,zowel_als)).
less_used_r1(q_pred).
less_used_r1(pred_pp_voor).
less_used_r1(mid_coord(vp)).
less_used_r1(end_coord(vc_noun,conj)).
less_used_r1(det_np_det).
less_used_r1(vpx_v_komma_mod).
less_used_r1(start_start_dubb_punt_q).
less_used_r1(start_coord(vc_noun,en)).
less_used_r1(pred_sbar_dp).
less_used_r1(num_num_haak).
less_used_r1(nucl_tag_sat(np)).
less_used_r1(n_score_n).
less_used_r1(np_adv_wh_np).
less_used_r1(n_n_predm_modified_np).
less_used_r1(n_n_npapp).
less_used_r1(mid_coord(pp)).
less_used_r1(deverbal_vp_arg_v(fixed_pred)).
less_used_r1(vast_staat).
less_used_r1(sv1_dip_sv1_q).
less_used_r1(ques_imp).
less_used_r1(np_red_rel_edep_sbar).
less_used_r1(np_is_np).
less_used_r1(mid_coord(finvp)).
less_used_r1(deverbal_v_v_v).
less_used_r1(abs_p_predc_vp_inv).
less_used_r1(vp_pp_v_en_pp).
less_used_r1(top_imp_tag_start_xp).
less_used_r1(start_coord(imp,en)).
less_used_r1(np_np_adv_non).
less_used_r1(n_n_num_number_app).
less_used_r1(modal_inv).
less_used_r1(max_xp(dip_sv1)).
less_used_r1(deverbal_vp_v_mod).
less_used_r1(bracketed_end_coord(np,conj,mod)).
less_used_r1(a_bracketed_mod_a).
less_used_r1(start_max_dip_no_comma).
less_used_r1(start_max_denk_ik).
less_used_r1(q_sbar).
less_used_r1(n_comma_adj_n_marked).
less_used_r1(dip_scope_root).
less_used_r1(dip_scope_imp).
