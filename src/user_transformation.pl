...
pos_lemma('WW(pv,tgw,mv)',vraag,vragen).
pos_lemma('WW(pv,verl,ev)',vraag,vragen).
pos_lemma('WW(vd,vrij,zonder)',vraag,vragen).
pos_lemma('WW(inf,vrij,zonder)',vraag,vragen).
pos_lemma('WW(pv,tgw,met-t)',vraag,vragen).
*/
...
lemma(frankrijk,'Frankrijk').
lemma(pro_israelisch,pro_israëlisch).
lemma(cjmv_gebouw,'CJMV_gebouw').
lemma('Bessemoer_straat','Bessemoerstraat').
lemma(bouw_vak_arbeider,bouwvak_arbeider).
lemma(gg,'GG').
lemma(gd,'GD').
lemma(kralingse,'Kralingse').
lemma(fre,'Fre').
lemma(meis,'Meis').
lemma(neerleggen,neer_leggen).
lemma(papiertje,papier).
lemma(patienen,patiënt).
lemma(platamais,'Platamais').
lemma(graanmarkt,graan_markt).
lemma(discussieren,discussiëren).
lemma(anglicaan,'Anglicaan').
lemma(christenen,christen).
lemma(carnavalsvereniging,carnaval_vereniging).
lemma(limburger,'Limburger').
lemma(beatle,'Beatles').
lemma(goeie,goed).
lemma(westlander,'Westlander').
lemma(erfurter,'Erfurter').
lemma(goud_schatten,goud_schat).
lemma(wery,'Wery').
lemma(tielse,'Tiels').
lemma(eerbeker,'Eerbeker').
lemma(indonesier,'Indonesiër').
lemma(mannetje,man).
lemma(praktisch,practisch).
lemma(gauloise,'Gauloise').
lemma('b.b.','B.B.').
lemma(rijksmuseum,'Rijksmuseum').

surf_lemma('Bartje',bar,'Bartje').
surf_lemma('Wijnen',wijn,'Wijnen').

/*
lemma(compagnieen,compagnie).
lemma(puzo,'Puzo').
lemma(nitsch,'Nitsch').
lemma(jiskoot,'Jiskoot').
lemma(larens,'Larens').
lemma(kattenhage,'Kattenhage').
lemma(allergroots,aller_groot).
lemma(wielersponsor,wieler_sponsor).
lemma(telkenjaar,telkenjare).
lemma(filliou,'Filliou').
lemma(ere_prijs,'Ereprijs').
lemma(canape,canapé).
lemma(louis,'Louis').
lemma(uitverkopen,uit_verkopen).
lemma(tweeen,twee).
lemma(aalbrecht,'Aalbrecht').
lemma(stad_rotterdam,stad_Rotterdam).
lemma(senaatssubcommissie,senaat_sub_commissie).
lemma(vlaardings,'Vlaardings').
lemma(toenemen,toe_nemen).
lemma(jaarbeursstedentoernooi,'Jaarbeurs_stad_toernooi').
lemma(omrijden,om_rijden).
lemma(aanbrengen,aan_brengen).
lemma(beverwijkse,'Beverwijks').
lemma(sinterklaaspakket,'Sinterklaas_pakket').
lemma(afbranden,af_branden).
lemma('heidemij.','Heidemij').
lemma(afvaardigen,af_vaardigen).
lemma(astmapatient,astma_patiënt).
lemma(voorleggen,voor_leggen).
lemma(vire,'Vires').
lemma(zielhorst,'Zielhorst').
lemma(strijkpenning,'Strijkpenning').
lemma(diepenhorst,'Diepenhorst').
lemma(prinzen,'Prinzen').
lemma(coitus,coïtus).
lemma(zaandams,'Zaandams').
lemma(ochtenduur,ochtend_uur).
lemma(svdpw,'SVDPW').
lemma(shenkie,'Shenkie').
lemma(elinkwijk,'Elinkwijk').
lemma('scholten-honig','Scholten-Honig').
lemma('k.n.s.m.','K.N.S.M.').
lemma('h.a.l.','H.A.L.').
lemma(vvv,'VVV').
lemma(dudley,'Dudley').
lemma('n.v.','N.V.').
lemma(sgp,'SGP').
lemma(ansa,'ANSA').
lemma(vara_voorzitter,'VARA_voorzitter').
lemma(meer_jarig_heid,meerderjarig_heid).
lemma(vorwarts,'Vorwarts').
lemma('Israel','Israël').
lemma(halfzacht,half_zacht).
lemma(rangeer_terrein,rangeren_terrein).
lemma(lcn_lid,'LCN_lid').
lemma(imf,'IMF').
lemma(koog,'Koog').
lemma('scholten-honig','Scholten-Honig').
lemma(partiij,partij).
lemma(auspicien,auspicën).
lemma(hongkongs,'Hongkongs').
lemma('top-twintigplaat','top-twintig_plaat').
lemma(ex_byrd,ex_Byrd).
lemma(eleanor,'Eleanor').
lemma(efficienter,efficiënt).
lemma(crech,crèche).
lemma(samendvatten,samenvatten).
lemma(waterweggebied,'Waterweg_gebied').
lemma(geenzins,geenszins).
lemma('staatscommissie-cals-donner','staatscommissie-Cals-Donner').
lemma(coordinatie,coördinatie).
lemma(voorlaatst,voor_laat).
lemma(schenking_act,schenking_acte).
lemma(hand_tekening_verzamelaar,handtekening_verzamelaar).
lemma(kleingeld,'Kleingeld').
lemma(symphatiek,sympathiek).
lemma(iet,'Iet').
lemma(vvv,'VVV').
lemma(horecaf,'Horecaf').
lemma(hondebeijten,hond_beet).
lemma(groningen_centrum,'Groningen_centrum').
lemma(dudley,'Dudley').
lemma(geciviliseren,geciviliseerd).
lemma(romeins,'Romeins').
lemma('n.v.','N.V.').
lemma(dindsdag,dinsdag).
lemma('Woensdag',woensdag).
lemma(sgp,'SGP').
lemma('Kaag_weg','Kaagweg').
lemma('staat-pers_bureau',staat_pers_bureau).
lemma(hectares,hectare).
lemma(bonies,'Bonies').
lemma(herley_speler,'Herley_speler').
lemma(fornaess,'Fornaess').
lemma(uitbroeien,uit_broeien).
lemma(eendracht,'Eendracht').
lemma(zonnetje,zon).
lemma(noorder_plantsoen,'Noorderplantsoen').
lemma(leeuwarder,'Leeuwarder').
lemma(zwanenberg,'Zwanenberg').
lemma(arnhems,'Arnhems').
lemma(havo_opleiding,'HAVO_opleiding').
lemma(falang,'Falange').
lemma(movimiento,'Movimiento').
lemma(adlai,'Adlai').
lemma(muskie,'Muskie').
lemma(state,staat).
lemma(weersomstandigheid,weer_omstandigheid).
lemma(textielunie,'TextielUnie').
lemma(cafe_houder,café_houder).
lemma(sexueel,seksueel).
lemma(asser,'Asser').
lemma(tt_race,'TT_race').
lemma(verblifa_debat,'Verblifa_debat').
lemma(snider,'Snider').
lemma(kromhout,'Kromhout').
lemma(symphatie,sympathie).
lemma('DWAZEN',dwaas).
lemma('GEKKEN',gek).
lemma('-ondernemer',ondernemer).
lemma(huizum,'Huizum').
lemma(brouwershavens,'Brouwershavens').
lemma(beedigen,beëdigen).
lemma(valkenier,'Valkenier').
lemma(elektrisch,electrisch).
lemma(hengelose,'Hengeloos').
lemma('mo-a','MO-A').

surf_lemma('Brandt',branden,'Brandt').
surf_lemma('Rijp',rijp,'Rijp').
surf_lemma('Zuilen',zuil,'Zuilen').



surf_lemma(premiere,premier,première).
surf_lemma(ruine,ruin,ruïne).

lemma(auserieux,'au sérieux').
lemma(inspelen,in_spelen).
lemma(bijwerken,bij_werken).
lemma(middeneuropees,'Middeneuropees').
lemma(voor_stel,voorstel).
lemma(overwegend,overwegen).
lemma(onbekende,onbekend).
lemma('oud-amstelvener','oud_Amstelvener').
lemma(amstelvener,'Amstelvener').
lemma('tv-sectie','tv_sectie').
lemma(isusprintkampioenschap,'ISU_sprint_kampioenschap').
lemma(californie,'Californië').
lemma(platenkopen,platen_kopen).
lemma(werkje,werk).
lemma(opbouwen,op_bouwen).
lemma(issels_methode,'Issels_methode').
lemma(issels,'Issels').
lemma(schoolgaan,school_gaan).
lemma(aardbeien_gepluk,aardbei_gepluk).
lemma(marseillaans,'Marseillaans').
lemma(scandinavie,'Scandinavië').
lemma(aanvoeren,aan_voeren).
lamma(maria,'Maria').
lemma(creeren,creëren).
lemma(indonesië, 'Indonesië').
lemma(capitol,'Capitol').
lemma(puzzolanie,'Puzzolanië').
lemma('r.u.','R.U.').
lemma(voorbereiden,voor_bereiden).
lemma(inslaan,in_slaan).
lemma(overnemen,over_nemen).
lemma(zeister,'Zeister').
lemma(ser,'SER').
lemma(netto_minimum_oom,netto_minimum_loon).
lemma(jeugdsocieteit,jeugd_societeit).
lemma(bouwerk,bouwwerk).
lemma(meeslepen,mee_slepen).
lemma(processenverbaal,'proces-verbaal').
lemma(terplaats,'ter plaatse').
lemma(aflopen,af_lopen).
lemma(principiele,principieel).
lemma(onmiddelijk,onmiddellijk).
lemma(doordraaien,door_draaien).
lemma(donkerbruin,donker_bruin).
lemma(tailleurjasje,tailleur_jas).
lemma(nosjournaal,'NOS_journaal').
lemma(landen_compeititie,land_competitie).
lemma('nieuwe-waterweggebied','Nieuwe-Waterweggebied').
lemma(resume,resumé).
lemma(gemenebest,'Gemenebest').
lemma(uitvoeren,uit_voeren).
lemma(gecombineren,combineren).
lemma(duindigen,'Duindigt').
lemma(notariel,notarieel).
lemma(aog,'Aogtje').
lemma(bredaas,'Bredaas').

lemma(aanleren,aan_leren).
lemma(aftreden,af_treden).
lemma(frustatie,frustratie).
lemma(oberbayern,'Oberbayern').
lemma(scandinavie,'Scandinavie').
lemma(bossche,'Bossch').
lemma(opbouwen,op_bouwen).
lemma(aankondigen,aan_kondigen).
lemma(uitvoeren,uit_voeren).
lemma(uitdrukken,uit_drukken).
lemma(havenschap,'Havenschap').
lemma(uitspreken,uit_spreken).
lemma(oprichten,op_richten).
lemma(uitgaan,uit_gaan).
lemma(uitbreiden,uit_breiden).
lemma(meekomen,mee_komen).
lemma(bergsma,'Bergsma').
lemma(fijnsnijden,fijn_snijden).
lemma(doodsteken,dood_steken).
lemma(strijen,'Strijen').
lemma(venema,'Venema').
lemma(prive,privé).
lemma(inhouden,in_houden).
lemma(inkorten,in_korten).
lemma(insluiten,in_sluiten).
lemma(gadeslaan,gade_slaan).
lemma(toestaan,toe_staan).
lemma('a.r.p.','ARP').
lemma(congresganger,congres_ganger).
lemma(hoogevener,'Hoogevener').
lemma(hoogenbosch,'Hoogenbosch').
lemma(laotiaans,'Laotiaans').
lemma(cypriotisch,'Cypriotisch').
lemma(cnv,'CNV').
lemma(uitdrukken,uit_drukken).
lemma(aannemen,aan_nemen).
lemma(uitsluiten,uit_sluiten).
lemma(oplopen,op_lopen).
lemma(euratom,'Euratom').
lemma(prolyleenoxyen,prolyleenoxyde).
lemma(patient,patiënt).
lemma(aling,'Aling').
lemma(industriel,industrieel).
lemma(aanbieden,aan_bieden).
lemma(hellevoetsluis,'Hellevoetsluis').


lemma(landbouw_produkt,landbouw_product).
lemma(verbranding_produkt,verbranding_product).
lemma(zuivel_produkt,zuivel_product).
lemma(eiwit_produkt,eiwit_product).
lemma(produktie_faktor,productie_factor).
lemma(produktie_eenheid,productie_eenheid).
lemma(produktie_land,productie_land).
lemma(produktie_proces,productie_proces).
lemma(produktie_capaciteit,productie_capaciteit).
lemma(wereld_produktie,wereld_productie).
lemma(olie_produktie,olie_productie).
lemma(miljoen_produktie,miljoen_productie).
lemma('Disney_produktie','Disney_productie').
lemma(produktschap,productschap).
lemma(reproduktie,reproductie).



word_lemma('Attje',at,'Attje').
word_lemma('Jensen',jens,'Jensen').

lemma(groninger,'Groninger').
lemma(glaasje,glas).
lemma('Financien',financiën).
lemma(financien,financiën).
lemma(feijenoorder,'Feijenoorder').
lemma(degene,degeen).
lemma(crm,'CRM').
lemma('Brazilie','Brazilië').
lemma(atje,'Atje').
...
lemma(konden,kunnen).
lemma(mannen,man).
lemma(dergelijke,dergelijk).
lemma(oostduits,'Oost-Duits').
lemma(westduits,'West-Duits').
lemma(jongens,jongen).
lemma(langer,lang).
lemma(vroeger,vroeg).
lemma(dingen,ding).
lemma('Israelisch','Israëlisch').
lemma(financiel,financieel).
lemma(produktie,productie).
lemma(werkzaamheden,werkzaamheid).
lemma(halve,half).
lemma(opzetten,op_zetten).
lemma(ideeen,idee).
lemma(gedacht,gedachte).
lemma(commerciel,commercieel).
lemma(liever,lief).
lemma(anders,ander).
lemma(actie_comite,actie_comité).
lemma(miljoenen,miljoen).
lemma(kvp,'KVP').
lemma(bondsrepubliek,'Bondsrepubliek').
lemma('Zaterdag',zaterdag).
lemma(ure,uur).
lemma(oostduitser,'Oostduitser').
lemma(merckx,'Merckx').
lemma(communique,communiqué).
lemma(venetie,'Venetië').
lemma(reeel,reëel).
lemma(on_feilbaarheid,onfeilbaar_heid).
lemma(nkv,'NKV').
lemma(hielen,houden).
lemma(estudiantes,'Estudiantes').
lemma(chu,'CHU').
lemma(cafe,café).
lemma('west-berlijn','West-Berlijn').
lemma(svv,'SVV').
lemma(schiedammer,'Schiedammer').
lemma(reele,reëel).
lemma(psv,'PSV').
lemma(rijnmondgebied,'Rijnmondgebied').
lemma(ppp,'PPP').
lemma(liedje,lied).
lemma(keuning,'Keuning').
lemma(jordanie,'Jordanië').
lemma(jeuring,'Jeuring').
lemma('Israeli','Israëli').
lemma(nv,'NV').
lemma(uw,u).
lemma('d\'66','D\'66').
lemma('Brazilie','Brazilië').
...
lemma(comite,comité).
lemma(crm,'CRM').
lemma(terling,'Terlingen').
lemma(gehuwde,gehuwd).
lemma(trace,tracé).
lemma(lszen,'LSD').
lemma(cooperatief,coöperatief).
lemma(arabie,'Arabië').
lemma(happel,'Happel').
lemma(nsf,'NSF').
lemma(carri,carrière).
lemma(indonesie,indonesië).
lemma(sondergaard,'Sondergaard').
lemma(beeindigen,beëindigen).
lemma(adeel,'Adele').
*/
