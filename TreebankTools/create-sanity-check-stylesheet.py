...
def sanity_checks():
    ...
    check('//node[@root="inclusief" and @pt="vz"]','inclusief is not a prep but an adjective')
    check('//node[@root="incluis" and @pt="vz"]','incluis is not a prep but an adjective')
    check('//node[@root="uitgezonderd" and @pt="vz"]','uitgezonderd is not a prep but an adjective')
    check('//node[@root="voorbehouden" and @pt="vz"]','voorbehouden is not a prep but an adjective')
    check('//node[@root="bijgenaamd" and @pt="vz"]','bijgenaamd is not a prep but an adjective')
    check('//node[@word="betreffende" and @pt="vz"]','betreffende is not a prep but an adjective')
    check('//node[@root="daargelaten" and @pt="vz"]','daargelaten is not a prep but an adjective')
    check('//node[@root="gedoopt" and @pt="vz"]','gedoopt is not a prep but an adjective')
    check('//node[@root="geheten" and @pt="vz"]','geheten is not a prep but an adjective')
    check('//node[@root="genaamd" and @pt="vz"]','genaamd is not a prep but an adjective')
    check('//node[@root="getiteld" and @pt="vz"]','getiteld is not a prep but an adjective')
